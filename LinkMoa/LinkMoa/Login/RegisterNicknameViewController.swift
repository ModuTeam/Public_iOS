...
class RegisterNicknameViewController: UIViewController {
    ...
    static func storyboardInstance() -> RegisterNicknameViewController? {
        let storyboard = UIStoryboard(name: RegisterNicknameViewController.storyboardName(), bundle: nil)
