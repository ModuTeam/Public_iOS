...
class RegisterDetailCategoryViewController: UIViewController {
    ...
    static func storyboardInstance() -> RegisterDetailCategoryViewController? {
        let storyboard = UIStoryboard(name: RegisterDetailCategoryViewController.storyboardName(), bundle: nil)
