...
final class AddFolderCategoryViewController: UIViewController {
    ...
    var saveCategory: ((String, Int) -> ())?
    var saveDetailCategory: ((String, Int) -> ())?
    ...
    static func storyboardInstance() -> AddFolderCategoryViewController? {
        let storyboard = UIStoryboard(name: AddFolderCategoryViewController.storyboardName(), bundle: nil)
    ...
    @objc private func categoryViewTapped() {
        guard let selectCategoryBottomVC = SelectCategoryBottomViewController.storyboardInstance() else { return }
