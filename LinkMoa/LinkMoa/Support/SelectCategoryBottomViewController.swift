...
class SelectCategoryBottomViewController: UIViewController {
    ...
    var selectionHandler: ((String, Int) -> ())? // 카테고리 이름 / 카테고리 넘버
    
    var categoryNumbers: [Int] = []
    var categories: [String] = []

    static func storyboardInstance() -> SelectCategoryBottomViewController? {
        let storyboard = UIStoryboard(name: SelectCategoryBottomViewController.storyboardName(), bundle: nil)
...
extension SelectCategoryBottomViewController: UICollectionViewDataSource {
...
extension SelectCategoryBottomViewController: UICollectionViewDelegateFlowLayout {
...
extension SelectCategoryBottomViewController: UICollectionViewDelegate {
